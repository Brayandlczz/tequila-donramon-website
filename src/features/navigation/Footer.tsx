...
const Logo: FC<{ size?: "sm" | "md" }> = ({ size = "md" }) => (
  ...
  <a
    ...
    className={[
      "relative block focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--gold)]",
      ...
      <li key={label}>
        <a
          ...
          className={[
            ...
            "transition-all duration-300 hover:border-[var(--gold)] hover:text-[var(--gold)] hover:bg-white",
  ...
  return (
    <a
      ...
      className={[
        ...
        "hover:text-[var(--gold)] focus-visible:outline-none focus-visible:text-[var(--gold)]",
        mobile ? "text-[11px] leading-snug text-neutral-700" : "text-[13px] text-neutral-700",
      ].join(" ")}
    >
      <span
        aria-hidden="true"
        className="h-px shrink-0 bg-[var(--gold)]/40 transition-all duration-300 group-hover:bg-[var(--gold)] group-hover:w-4"
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-8 lg:px-16">
        ...
        <div className="py-7 sm:hidden">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-6">
            {COLUMNS.slice(0, 2).map(({ heading, links }) => (
              <nav key={heading} aria-label={`Sección ${heading}`}>
                <h2 className="mb-3 text-[8px] font-semibold uppercase tracking-[0.4em] text-[var(--gold)]">
                  {heading}
                </h2>
            ...
            <nav className="col-span-2" aria-label="Sección Legal">
              <h2 className="mb-3 text-[8px] font-semibold uppercase tracking-[0.4em] text-[var(--gold)]">
                Legal
              </h2>
        ...
        {/* Desktop */}
        <div className="hidden py-8 sm:grid sm:grid-cols-2 sm:gap-10 lg:grid-cols-4 lg:gap-10">
          <div className="flex flex-col gap-4">
            <Logo />
            <p className="max-w-[210px] text-[12px] italic leading-[1.8] text-neutral-600">
            ...
            <div>
              <p className="mb-2 text-[9px] font-semibold uppercase tracking-[0.45em] text-[var(--gold)]">
                Síguenos:
              </p>
              <SocialList />
            </div>
          ...
          {COLUMNS.map(({ heading, links }) => (
            <nav key={heading} aria-label={`Sección ${heading}`}>
              <h2 className="mb-4 text-[9px] font-semibold uppercase tracking-[0.5em] text-[var(--gold)]">
                {heading}
              </h2>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col gap-2 pt-5 sm:flex-row sm:items-center sm:justify-between text-center">
          <p className="text-[11px] text-neutral-600">
            © {CURRENT_YEAR} Casa Don Ramón | Todos los derechos reservados.
          </p>
          <p
            className="text-[10px] text-neutral-600 sm:text-right sm:whitespace-nowrap"
